 ...
 */
final class Version20250423135619 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, courriel VARCHAR(180) NOT NULL, medias_de_contact LONGTEXT NOT NULL COMMENT '(DC2Type:json)', roles LONGTEXT NOT NULL COMMENT '(DC2Type:json)', password VARCHAR(255) NOT NULL, prenom VARCHAR(50) NOT NULL, nom VARCHAR(50) NOT NULL, genre VARCHAR(20) NOT NULL, telephone_fixe VARCHAR(30) DEFAULT NULL, telephone_mobile VARCHAR(30) DEFAULT NULL, rue_et_numero VARCHAR(255) NOT NULL, code_postal VARCHAR(20) NOT NULL, ville VARCHAR(100) NOT NULL, societe VARCHAR(100) DEFAULT NULL, date_heure_insertion DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', date_heure_maj DATETIME DEFAULT NULL, is_verified TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_COURRIEL (courriel), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
